...
void letterCombinationsCore(const std::string &digits, int index, std::string &combine, std::vector<std::string> &result)
{
...
int main()
{
    ...
    for (int i = 2; i <= 9; i++)
    {
        for (int j = 2; j <= 9; j++)
        {
            print(letterCombinations(std::to_string(i) + std::to_string(j)));
        }
    }
